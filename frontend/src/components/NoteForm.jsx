...
import { CoverUploader } from './cover';
...
export default function NoteForm() {
    ...
    if (id) {
      ...
      api
        ...
        .then((response) => {
          ...
          setCoverThumbnail(note.cover_thumbnail || null);
        })
  ...
  const handleCoverUploaded = (coverUrl, thumbnailUrl) => {
    setCover(coverUrl);
    setCoverThumbnail(thumbnailUrl);
    showNotification('Cover uploaded successfully!');
  };

  const handleCoverDeleted = () => {
    setCover(null);
    setCoverThumbnail(null);
    showNotification('Cover deleted successfully!');
  };
      ...
      <div className='bg-white p-8 rounded-lg shadow-lg w-full max-w-md'>
        ...
        <form onSubmit={handleSubmit}>
          <div className='mb-4'>
            ...
            <CoverUploader noteId={noteId} currentCover={cover} onCoverUploaded={handleCoverUploaded} onCoverDeleted={handleCoverDeleted} />
          </div>
          <div className='mb-4'>
          ...
          <div className='text-center'>
            <input type='submit' value='Submit' className='w-full bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-600 transition duration-300 ease-in-out cursor-pointer' />
          </div>
        </form>
      </div>
    </div>
